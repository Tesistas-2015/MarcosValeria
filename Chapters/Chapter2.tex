...
(SISTEMAS AUTOMATICOS DE DIAGNOSTICO, EJEMPLOS -> en el trabajo de tal y tal se presento un sistema basado en tal y tal cosa que hace tal otra.  -- 3 ejemplos por enfermedad).
%----------------------------------------------------------------------------------------
%	SECTION 2
%----------------------------------------------------------------------------------------
