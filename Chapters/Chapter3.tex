...
La vascularizaci\'on retiniana se compone de arterias y venas que aparecen como caracteristicas alargadas, con sus afluentes visibles dentro de la imagen de la retina. Hay una amplia gama de vasos que van desde 1 a 20 p\'ixeles de ancho.
El cruce y ramificaci\'on de los vasos sanguineos pueden complicar el perfil (contorno) del modelo.  Al igual que con el procesamiento de la mayor\'ia de las im\'agenes m\'edicas, la señal de ruido, la deriva en intensidad de la imagen y la falta de contraste de imagen plantean retos importantes para la extracci\'on de vasos sangu\'ineos. \cite{fraz2012blood}
