...
\graphicspath {Figures} 
	  \label{fig:color}}
		\subfloat{\includegraphics[width=0.3\textwidth]{01_dr} \label{fig:retinopatia}}
		\subfloat{\includegraphics[width=0.3\textwidth]{01_g} \label{fig:glaucoma}}
		\subfloat{\includegraphics[width=0.3\textwidth]{01_h} \label{fig:sana}}
